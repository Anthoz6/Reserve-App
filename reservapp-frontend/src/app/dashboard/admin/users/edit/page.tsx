    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      ...
      >
        ...
        <div className="space-y-2">
          ...
          <Input name="name" value={user.name} onChange={handleChange} required disabled={saving} />
        </div>
        <div className="space-y-2">
          <label className="block text-sm font-medium">Email</label>
          <Input name="email" type="email" value={user.email} onChange={handleChange} required disabled={saving} />
        </div>
        <div className="flex items-center gap-3">
          <Switch checked={user.enabled} onCheckedChange={handleToggleEnabled} disabled={saving} />
        ...
        <div className="space-y-2">
          ...
          <Select value={roleId ? String(roleId) : undefined} onValueChange={handleRoleChange} disabled={saving}>
